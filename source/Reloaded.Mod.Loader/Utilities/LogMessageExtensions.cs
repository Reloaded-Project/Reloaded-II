...
namespace Reloaded.Mod.Loader.Utilities
{
    ...
    {
        public static void LogWriteLine(this ILogger logger, string message) => logger.WriteLine(AddLogPrefix(message));
        ...
        public static string AddPrefix(this string message, string prefix = "[Reloaded] ") => AddLogPrefix(message, prefix);
    }
}
